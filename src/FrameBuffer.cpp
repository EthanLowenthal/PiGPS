...
private:
  void open_fb()
  {
    ...
    std::cout << "fb res " << fb_info.var.xres << "x" << fb_info.var.yres << ", virtual " << fb_info.var.xres_virtual << "x" << fb_info.var.yres_virtual << ", line_len " << fb_info.fix.line_length << ", bpp " << fb_info.var.bits_per_pixel << std::endl;
